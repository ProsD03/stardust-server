...
class ChoiceObject(BaseModel):
    ...
    finish_reason: FinishReasonEnum = Field(description="Reason for completion finish. Must be either stop, length, or content_filter")
...
class CompletionsResponse(BaseModel):
    ...
    usage: UsageObject = Field(description="Usage object for this completion")
